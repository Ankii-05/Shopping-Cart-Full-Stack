...
const addUsers = async(req,res)=>{
    ...
    // userGender validation
        ...
        if(!validGenders.includes(userGender)){
    ...
    let users = await userModel.create(userData);
...
const updateUser = async (req,res)=>{
    ...
    if(userAge != undefined){
        ...
        let updatedData = await userModel.findByIdAndUpdate(userId, userData, {new:true} )
